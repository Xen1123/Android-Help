...
PS3='Would You Like To Just Remove The Normal Apps Or Remove The Normal Apps And The Google Apps (GMS Services, Play Store, etc.)?
'
options=("Remove Normal Apps" "Remove Normal Apps And Google Apps")
...
exit
;;
"Remove Normal Apps And Google Apps")
apps=(
